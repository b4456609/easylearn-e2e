...
public class AddVersionTest {
    ...
    public void addVersionTest() throws Exception {
        String content = "Kirkenes, Norway (CNN)An American tank full of US Marines crashes through the silence of the sub-zero pine forest, far above the Arctic Circle, as unidentified drones hover overhead and yellow and green smoke fills the freezing air.\n" +
                "\n" +
